...
def parse_options(argv):
    ...
    experimental_test.add_argument('--non-alt-norm', dest='non_alt_norm', action='store_true', metavar='y|n', help='only use non alternative exon segments for gene expression counting [n]', default='n')
    experimental_test.add_argument('--low-memory', dest='low_memory', metavar='y|n', help='use less memory at the cost of longer running time [n]', default='n')
    ...
    general_viz.add_argument('-V', '--validate-sg', dest='validate_sg', metavar='y|n', help='validate splice graph [n]', default='n')
