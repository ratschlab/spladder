function [idx_xor_exons, exon_xor_exons,id_xor_exons] = detect_doubleexonskips(genes, idx_alt);
          ...
          if edges(exon_idx1, exon_idx3) & ...
            ...
            for exon_idx4=(exon_idx3+1):num_exons
              if edges(exon_idx2, exon_idx4) & edges(exon_idx3, exon_idx4) & ...
                    (edges(exon_idx2, exon_idx3)~=0 | edges(exon_idx1, exon_idx4)~=0)
