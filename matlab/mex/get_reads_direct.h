...
int get_reads_from_bam(char* filename, char* region, vector<CRead*>* reads, char strand, int lsubsample, bool var_aware = false);
void parse_cigar(bam1_t* b, CRead* read, bam_header_t* header, bool var_aware = false);
